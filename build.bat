...
IF %ERRORLEVEL% NEQ 0 GOTO ERROR
mkdir %MAPNIK_SDK%\include\libxslt
xcopy /i /d /s /q %DEPSDIR%\libxslt\libxslt\*.h %MAPNIK_SDK%\include\libxslt /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERROR
...
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libxslt.lib %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libxslt_a.lib %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libexslt.lib %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libexslt_a.lib %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libexslt.dll %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
xcopy /q /d %DEPSDIR%\libxslt\win32\bin.msvc\libxslt.dll %MAPNIK_SDK%\lib\ /Y
IF %ERRORLEVEL% NEQ 0 GOTO ERRO
